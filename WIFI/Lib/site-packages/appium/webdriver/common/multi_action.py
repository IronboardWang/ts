...
from apptest.webdriver.mobilecommand import MobileCommand as Command

if TYPE_CHECKING:
    from apptest.webdriver.webdriver import WebDriver
    from apptest.webdriver.webelement import WebElement
    from apptest.webdriver.common.touch_action import TouchAction
